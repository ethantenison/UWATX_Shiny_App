...
#2017renaming column headers and filtering for Travis country zipcodes
        ...
        poverty_status_2017 <- filter(poverty_status_2017, zipcode %in% c(78617, 78641,78641, 78645, 78645, 78645, 78645 ,  
...
#2016
        ...
        poverty_status_2016 <- mutate(poverty_status_2016, zipcode = as.numeric(as.character(zipcode)), 
                                      percent_below_poverty_level = as.numeric(as.character(percent_below_poverty_level)))
        poverty_status_2016 <- filter(poverty_status_2016, zipcode %in% c(78617, 78641,78641, 78645, 78645, 78645, 78645 ,  
                78651,78652,78653, 78660, 78669, 78669, 78691,78701, 78702,78703, 78704, 78705, 78708, 78709 ,78710, 78711
                ,78713,78714,78715,78716,78718,78719,78720,78721,78722,78723,78724,78725,78726,78727,78728,78730,78731,
                78732, 78733,78733, 78733, 78734,78734,78734,78734,78735, 78735,78736)) #78712 is excluded, it represents UT 
...
#2014
        ...
        poverty_status_2014 <- mutate(poverty_status_2014, zipcode = as.numeric(as.character(zipcode)), 
                                      percent_below_poverty_level = as.numeric(as.character(percent_below_poverty_level)))
        poverty_status_2014 <- filter(poverty_status_2014, zipcode %in% c(78617, 78641,78641, 78645, 78645, 78645, 78645 ,  
                                                                          78651,78652,78653, 78660, 78669, 78669, 78691,78701, 78702,78703, 78704, 78705, 78708, 78709 ,78710, 78711
                                                                          ,78713,78714,78715,78716,78718,78719,78720,78721,78722,78723,78724,78725,78726,78727,78728,78730,78731,
                                                                          78732, 78733,78733, 78733, 78734,78734,78734,78734,78735, 78735,78736)) #78712 is excluded, it represents UT 
...
#2013
        ...
        poverty_status_2013 <- mutate(poverty_status_2013, zipcode = as.numeric(as.character(zipcode)), 
                                      percent_below_poverty_level = as.numeric(as.character(percent_below_poverty_level)))
        poverty_status_2013 <- filter(poverty_status_2013, zipcode %in% c(78617, 78641,78641, 78645, 78645, 78645, 78645 ,  
                                                                          78651,78652,78653, 78660, 78669, 78669, 78691,78701, 78702,78703, 78704, 78705, 78708, 78709 ,78710, 78711
                                                                          ,78713,78714,78715,78716,78718,78719,78720,78721,78722,78723,78724,78725,78726,78727,78728,78730,78731,
                                                                          78732, 78733,78733, 78733, 78734,78734,78734,78734,78735, 78735,78736)) #78712 is excluded, it represents UT 
