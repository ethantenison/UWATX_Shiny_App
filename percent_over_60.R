...
#2013renaming column headers and filtering for Travis country zipcodes
        ...
        over60_2013 <- filter(over60_2013, zipcode %in% c( 78617,78641, 78645,78651 , 78652, 78653, 78660, 78669, 78691, 78701, 78702, 78703, 78704, 78705, 
...
#2014
        ...
        over60_2014 <- mutate(over60_2014, zipcode = as.numeric(as.character(zipcode)), 
                              percent_over60 = as.numeric(as.character(percent_over60)))
        over60_2014 <- filter(over60_2014, zipcode %in% c( 78617,78641, 78645,78651 , 78652, 78653, 78660, 78669, 78691, 78701, 78702, 78703, 78704, 78705, 
                                                           78708, 78709, 78710 , 78711, 78713, 78714, 78715, 78716, 78718, 78719, 78720, 78721, 78722, 78723, 
                                                           78724, 78725, 78726, 78727, 78728, 78730, 78731, 78732,78733, 78734, 78735, 78736, 78738, 78739, 78741,
                                                           78742, 78744, 78745, 78746, 78747, 78748, 78749, 78750, 78751, 78752, 78753, 78754, 78755, 78756, 78757, 78758
                                                           ,78759, 78760, 78761, 78762, 78763, 78764, 78765, 78766, 78767, 78768, 78769)) #78712 is excluded,represents UT 
 ...
 #2015
        ...
        over60_2015 <- mutate(over60_2015, zipcode = as.numeric(as.character(zipcode)), 
                              percent_over60 = as.numeric(as.character(percent_over60)))
        over60_2015 <- filter(over60_2015, zipcode %in% c( 78617,78641, 78645,78651 , 78652, 78653, 78660, 78669, 78691, 78701, 78702, 78703, 78704, 78705, 
                                                           78708, 78709, 78710 , 78711, 78713, 78714, 78715, 78716, 78718, 78719, 78720, 78721, 78722, 78723, 
                                                           78724, 78725, 78726, 78727, 78728, 78730, 78731, 78732,78733, 78734, 78735, 78736, 78738, 78739, 78741,
                                                           78742, 78744, 78745, 78746, 78747, 78748, 78749, 78750, 78751, 78752, 78753, 78754, 78755, 78756, 78757, 78758
                                                           ,78759, 78760, 78761, 78762, 78763, 78764, 78765, 78766, 78767, 78768, 78769)) #78712 is excluded,represents UT 
 ...
 #2016
        ...
        over60_2016 <- mutate(over60_2016, zipcode = as.numeric(as.character(zipcode)), 
                              percent_over60 = as.numeric(as.character(percent_over60)))
        over60_2016 <- filter(over60_2016, zipcode %in% c( 78617,78641, 78645,78651 , 78652, 78653, 78660, 78669, 78691, 78701, 78702, 78703, 78704, 78705, 
                                                           78708, 78709, 78710 , 78711, 78713, 78714, 78715, 78716, 78718, 78719, 78720, 78721, 78722, 78723, 
                                                           78724, 78725, 78726, 78727, 78728, 78730, 78731, 78732,78733, 78734, 78735, 78736, 78738, 78739, 78741,
                                                           78742, 78744, 78745, 78746, 78747, 78748, 78749, 78750, 78751, 78752, 78753, 78754, 78755, 78756, 78757, 78758
                                                           ,78759, 78760, 78761, 78762, 78763, 78764, 78765, 78766, 78767, 78768, 78769)) #78712 is excluded,represents UT 
...
#2017
        ...
        over60_2017 <- mutate(over60_2017, zipcode = as.numeric(as.character(zipcode)), 
                              percent_over60 = as.numeric(as.character(percent_over60)))
        over60_2017 <- filter(over60_2017, zipcode %in% c( 78617,78641, 78645,78651 , 78652, 78653, 78660, 78669, 78691, 78701, 78702, 78703, 78704, 78705, 
                                                           78708, 78709, 78710 , 78711, 78713, 78714, 78715, 78716, 78718, 78719, 78720, 78721, 78722, 78723, 
                                                           78724, 78725, 78726, 78727, 78728, 78730, 78731, 78732,78733, 78734, 78735, 78736, 78738, 78739, 78741
                                                           78742, 78744, 78745, 78746, 78747, 78748, 78749, 78750, 78751, 78752, 78753, 78754, 78755, 78756, 78757, 78758
                                                           ,78759, 78760, 78761, 78762, 78763, 78764, 78765, 78766, 78767, 78768, 78769)) #78712 is excluded,represents UT 
